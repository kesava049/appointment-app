...
export default function DoctorProfilePage() {
  ...
  useEffect(() => {
    if (params && params.id && doctors.length) {
  ...
  if (!doctor) return <div className="text-center mt-20 text-gray-600">Loading doctor data...</div>;
  ...
  return (
    <main className="max-w-xl mx-auto px-4 py-10">
      <div className="flex flex-col items-center">
        ...
        <p className={`mt-2 ${
          doctor.availability === "Available Today" ? "text-green-600"
          : doctor.availability === "Fully Booked" ? "text-red-600"
          : "text-yellow-600"
        }`}>
          {doctor.availability}
        </p>
      ...
      {!confirmed && !showForm && (
        <button
          ...
          title={doctor.availability !== "Available Today"
      ...
      <div className="mt-10">
        ...
        {doctor.schedule.length === 0 && <p>No schedule available.</p>}
